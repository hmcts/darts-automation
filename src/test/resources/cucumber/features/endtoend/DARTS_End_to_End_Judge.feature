Feature: Judge
  ...
  Scenario Outline: Judge
    ...
    Examples:
      ...
      | DARTS_E2E_{{date+0/}}_{{seq}} | DL      | DL         | Dailylist_{{date+0/}} | {{courthouse1}} | C{{seq}}-88 | {{displaydate}} | S{{seq}}081-B088 | {{date+0}} | {{date+30}} | {{timestamp}} | S{{seq}} judge-B088 | S{{seq}} defendant-B088 | S{{seq}} prosecutor-B | S{{seq}} defender-B | {{seq}}001 | {{seq}}1001 |               |               | sample1   | 08:04:00  | 08:05:00 | Annotations.docx    |