...
#    Given I authenticate from the DARPCMIDTIER source system
    ...
    Examples:
      ...
      | DARTS_E2E_{{date+0/}} | DL      | DL         | Dailylist_{{date+0/}} | Harrow Crown Court | {{seq}}   | S{{seq}}001 | {{date-2}} | 10:00:00  | {{date+30}} | {{timestamp}} | S{{seq}} defendants | {{seq}}001 | {{seq}}1001 |               |               | SIT LOG{{seq}} |
