...
#      | <courthouse> | <case_number> | <defendants> | <judges> | <prosecutors> | <defenders> |
    ...
    Examples:
      ...
      | DARTS_E2E_{{date+0/}}_{{seq}} | DL      | DL         | Dailylist_{{date+0/}} | {{courthouse1}} | C{{seq}}  | {{todayDisplay()}} | S{{seq}}089-B | {{date+0}} | {{date+30}} | {{timestamp}} | S{{seq}} defendant-B | {{seq}}001 | {{seq}}001 |               |               | sample1.mp2 | 08:04:00  | 08:05:00 |
