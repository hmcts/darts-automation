...
#    Then I see "using filters to restrict the number of results" on the page
    ...
    Examples:
      ...
      | REQUESTER   | {{courthouse1}} | C{{seq}}091  | S{{seq}}091-B | {{timestamp}} | {{seq}}082 | {{seq}}1042 | 21200 | 11000   |               |               | S{{seq}} prosecutor-B091 | S{{seq}} defender-B091 | S{{seq}} defendant-B091 | S{{seq}} judge-B091 | SIT LOG-82-{{seq}}-B091 | {{date+0/}} |
      | JUDGE       | {{courthouse1}} | C{{seq}}092  | S{{seq}}092-B | {{timestamp}} | {{seq}}082 | {{seq}}1042 | 21200 | 11000   |               |               | S{{seq}} prosecutor-B092 | S{{seq}} defender-B092 | S{{seq}} defendant-B092 | S{{seq}} judge-B092 | SIT LOG-82-{{seq}}-B092 | {{date+0/}} |
      | TRANSCRIBER | {{courthouse1}} | C{{seq}}093  | S{{seq}}093-B | {{timestamp}} | {{seq}}082 | {{seq}}1042 | 21200 | 11000   |               |               | S{{seq}} prosecutor-B093 | S{{seq}} defender-B093 | S{{seq}} defendant-B093 | S{{seq}} judge-B093 | SIT LOG-82-{{seq}}-B093 | {{date+0/}} |
