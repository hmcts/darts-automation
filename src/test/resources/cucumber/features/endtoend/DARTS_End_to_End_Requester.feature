...
#      | REQUESTER | <courthouse> | <case_number> | {{date+0/}}  |
    ...
    Examples:
      ...
      | DARTS_E2E_{{date+0/}}_{{seq}} | DL      | DL         | Dailylist_{{date+0/}} | {{courthouse1}} | C{{seq}}-86 | S{{seq}}086-B | {{seq}}001 | S{{seq}} defendant-86 | {{date+0}} | 10:00:00     | {{date+30}} | {{timestamp}} | {{displaydate}} | Sentencing remarks | Overnight |               |               | {{timestamp}} | sample1.mp2 | 08:03:00  | 08:04:00 | file-sample_1MB.doc | 99 Years Permanent Retention for case S{{seq}}009 |
