Feature: Events Endpoints
  ...
  Scenario Outline: Create a case with dailylists
    ...
    Examples:
      ...
      | APPROVER | Harrow Crown Court | {{seq}}   | {{date+0}}   | Courtroom SIT {{seq}} | S{{seq}}001  | defendant SIT{{seq}} |


  @end2end @end2end4
  #Add Audio via Post event using SOAP
  Scenario Outline: Add Audio
    Given I add Audio to the case
      | startDateTime   | endDateTime   | channel   | max_channels   | mediaformat   | mediafile   | courthouse   | courtroom   | case_numbers  |
      | <startDateTime> | <endDateTime> | <channel> | <max_channels> | <mediaformat> | <mediafile> | <courthouse> | <courtroom> | <case_number> |

    Examples:
      | user     | channel | max_channels | mediaformat | mediafile | courthouse         | courtroom | case_number | startDateTime | endDateTime   |
      | APPROVER | 1       | 5            | mpeg2       | 0001.a00  | Harrow Crown Court | {{seq}}   | S{{seq}}001 | {{timestamp}} | {{timestamp}} |
